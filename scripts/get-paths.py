...
def main():
    ...
    version_pattern = "plotly/python/versions/*/Q*_*"

    # Define directories to exclude
    exclude_dirs = ["dist", "specs", "test", "tests", "doc", "validators", "codegen"]

    # Output file
    output_file = "plotly/python/inputs-quarter.txt"
    ...
    for version_dir in version_dirs:
        ...
        # Find all Python files in this version directory
        python_files = []
